...
* @since 1.0.0
*/
class SiteDescription extends \WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array(
				...
				'description' => __( 'Inserts the website\'s description ( tagline ) into your template.', 'boldgrid-editor' )
			)
		);
	}
	...
	public function widget( $args, $instance )  {
		...
		echo '<h1 class="site_title" style="font-size: inherit; color: inherit; text-align: ' . $alignment . ';">' . $site_description . '</h1>';
	}
