...
* Bug Fix: Max input goes from 50 to 5 after closing and reopening same panel [#608](https://github.com/BoldGrid/post-and-page-builder/issues/608)
* Bug Fix: Hide Customize Design button from Primary / Secondary if Crio is active theme [#507](https://github.com/BoldGrid/post-and-page-builder/issues/507)

= 1.27.3 =
* Bug Fix: Change placeholder provider to placehold.co [#627](https://github.com/BoldGrid/post-and-page-builder/pull/627)
